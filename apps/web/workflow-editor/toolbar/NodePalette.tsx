  ...
  const nodeTypesList = [
    ...
    },
    {
      ...
      nodes: [
        ...
        { type: 'code-script', label: 'Custom Code Script', icon: <Code size={16} />, color: 'bg-indigo-50 dark:bg-indigo-950/30 text-indigo-600 dark:text-indigo-400 border-indigo-200 dark:border-indigo-900/60 hover:bg-indigo-100 dark:hover:bg-indigo-900/30' },
        { type: 'human-approval', label: 'Human Approval', icon: <UserCheck size={16} />, color: 'bg-amber-50 dark:bg-amber-950/30 text-amber-600 dark:text-amber-400 border-amber-200 dark:border-amber-900/60 hover:bg-amber-100 dark:hover:bg-amber-900/30' },
